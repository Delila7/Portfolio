...
#set up basic configuration of web app
#https://webfx.com/tools/emoji-cheat-sheet
st.set_page_config(page_title='Sales Dashboard',
                  page_icon=':bar_chart:',
                  layout='wide' #'centered' is default
) 

#Read in Excel File of Sales Data, cache dataframe locally so it doesn't have to load each time.
@st.cache
...
# print(df) ##prints dataframe in console
#st.dataframe(df) #dataframe on webpage (localhost)
